...
## Description
In this project, I built a simple article recommender engine using a natural language processing called word2vec. I used word embedding from [Stanford's GloVe project](https://nlp.stanford.edu/projects/glove/).
